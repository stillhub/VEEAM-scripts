# Script that enables list of backups (BackupJobs.csv) on a remote computer running VEEAM.
...
Invoke-Command -ComputerName $RemotePC -ScriptBlock {
    ...
    function ExecuteEnabling{
        ...
        Import-Csv -Path $BackupJobs | ForEach-Object {Get-VBRJob -Name $_.'BackupName' | Enable-VBRJob}
    }
